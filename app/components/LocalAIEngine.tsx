...
export default function LocalAIEngine() {
  ...
  return (
    <div className="hidden lg:flex items-center gap-3 px-3 py-1.5 bg-slate-900/90 rounded-xl border border-slate-800 text-xs">
      <div className="flex items-center gap-2">
        <Server className="w-4 h-4 text-cyan-400" />
        <span className="font-mono text-slate-300 hidden xl:inline">Local AI:</span>
        <span
      ...
      <div className="flex items-center gap-1.5">
        ...
        >
          ...
          <span className="hidden xl:inline">START PROXIMA AI</span>
        </button>
        ...
        >
          ...
          <span className="hidden xl:inline">TEST LOCAL OLLAMA</span>
        </button>
